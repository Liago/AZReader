...
const sampleArticles: EnhancedSearchResult[] = [
  {
    ...
    content: 'This comprehensive guide explores how machine learning algorithms can be integrated into modern JavaScript applications using TensorFlow.js and other ML libraries...',
    ...
    snippet: 'JavaScript applications can now leverage powerful machine learning capabilities through browser-based libraries. This article demonstrates practical implementations...',
  ...
  },
  {
    ...
    content: 'Learn advanced React patterns including render props, compound components, and custom hooks for building scalable user interfaces...',
    ...
    snippet: 'React patterns provide powerful abstractions for component composition. This guide covers advanced techniques for professional JavaScript development...',
    matched_fields: ['title', 'content', 'tags'],
    search_context: {
      query_type: 'simple',
  ...
  },
  {
    ...
    snippet: 'Node.js provides an excellent runtime for building scalable backend applications. This tutorial covers API design patterns and best practices...',
